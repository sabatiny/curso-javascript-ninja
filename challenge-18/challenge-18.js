(function() {
    ...
    */
    ...
    var matchRegex = /ju[nl]ho/g;
    var matchFrase = frase.match(matchRegex);
    console.log(matchFrase)
    ...
    */
    ...
    var Aberturatag = "<div><section><blockquote>Texto <img /></blockquote></section></div>";
    console.log(Aberturatag.match(/<(\w+)>/g));
